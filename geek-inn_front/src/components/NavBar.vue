        ...
        <nav class="bm-item-list">
          ...
          <div class="divclasse">
            <nav class="nav-normal">
              ...
              <br /><router-link to="/reviews">Commentaire</router-link><br />
              ...
              <br /><router-link to="/signin">Connection</router-link><br />
              <br /><router-link to="/signup">Inscription</router-link><br />
              <br /><router-link
                to="#"
              ...
              <br /><router-link to="/admin">Admin</router-link><br />
              <br /><router-link to="/dashboard">Dashboard</router-link><br />
            </nav>
          </div>
          <!-- </component> -->
        </nav>
